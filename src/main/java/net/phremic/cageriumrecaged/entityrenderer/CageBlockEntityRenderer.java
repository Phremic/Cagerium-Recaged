...
public class CageBlockEntityRenderer extends FarmBlockEntityRenderer {

    public CageBlockEntityRenderer(BlockEntityRendererProvider.Context pContext) {
        super(pContext);
    }
    ...
    public void render(@NotNull FarmBlockEntity pBlockEntity, float pPartialTick, @NotNull PoseStack pPoseStack, @NotNull MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
        renderEntity(pBlockEntity, 0.125f, pPartialTick, pPoseStack, pBuffer, pPackedLight, pPackedOverlay);
    }
}
